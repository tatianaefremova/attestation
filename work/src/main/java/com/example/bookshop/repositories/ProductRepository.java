...
public interface ProductRepository extends JpaRepository<Product, Integer> {
    ...
    List<Product> findByTitleAndCategoryAndPriceGreaterThanEqualAndPriceLessThanEqual(String title, float ot, float Do, int category);
    ...
    List<Product> findByTitleAndCategory(String name, int category);
}
